...
# ---- Agent Setup ----
# Cortex Agent disabled - using different text2sql solution
...
# Reuse the same DeepSeek configuration
# llm is already defined above, but redeclaring for clarity in this section
llm = AzureAIChatCompletionsModel(
        model_name='DeepSeek-V3-0324')
...
# Evaluations - Disabled due to missing TruLens imports
